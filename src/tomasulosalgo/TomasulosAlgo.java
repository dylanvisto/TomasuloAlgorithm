...
//        rsArray[4] = rs5;
        ...
        try {
            ...
            for(int i = 0; i < numInstr; i++){
                ...
                instrHold.enqueue(new Instruction(opCode, destOp, sourceOp1, sourceOp2, i));  
            }
